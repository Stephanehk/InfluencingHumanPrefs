...
#     for i, pref_condition in enumerate(["REGRET_UI_", "PARTIAL_RETURN_UI_","NO_STATS_UI_"]):
#         for model in ["regret_regret", "pr_pr"]:
#             near_opts = []
...
#                 print (near_opts)
#                 ax[i].plot(x_ticks, near_opts, color="blue")
#             elif model == "pr_pr":
#                 print (near_opts)
#                 ax[i].plot(x_ticks, near_opts, color="red")

#         if pref_condition == "":
#             title = "NO_STATS_UI"
#         else:
#             title = pref_condition[:-1]
...
def main():
    ...
    for i, model in enumerate(["regret_regret", "pr_pr"]):
        ...
        if model == "regret_regret":
            title = "Regret pref. model"
        elif model == "pr_pr":
            title = "Partial return pref. model"
